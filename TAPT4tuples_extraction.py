...
def load_dataset_multiple_opinions(dataset_ref, tokenizer, max_length):
    ...
    #dev = semeval_datasets_dir + "/preprocessed/{0}/dev.csv".format(dataset_ref)
...
def TAPT(train_dataset, model, dataset_ref, epochs):
    training_args = TrainingArguments(output_dir='models/' + dataset_ref, 
...
if __name__ == '__main__':
    ...
    parser.add_argument("dataset", type=str, help="the identifier of the dataset being processed")
    args = parser.parse_args()

    dataset_ref = args.dataset  #"16res"
    epochs = 3  # tune
    max_length = 400
    ...
    #train_dataset, dev_dataset = load_dataset(dataset_ref, tokenizer, max_length)
